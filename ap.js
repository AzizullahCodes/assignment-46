...
// // console.log(newNum)
// /*________________________ Question no 41 __________________________
// Write a JavaScript program that asks the user for the radius of a circle and calculates:

// Circumference of the circle → formula: 2 * Math.PI * radius

// Area of the circle → formula: Math.PI * radius * radius
...
// /*________________________ Question no 43 __________________________
// .toString()
// _________________________ Answer ____________________________*/
// // let num = 32;
...
// /*________________________ Question no 44 __________________________
...
// // str = parseInt(str);
// // console.log(str,typeof str);
// /*________________________ Question no 45 __________________________
// .length
// _________________________ Answer ____________________________*/
// // let str = 'hello';
// // console.log(str.length);
// /*________________________ Question no 46 __________________________
// .charAt()
// _________________________ Answer ____________________________*/
// // let str = 'goodLuck';
// // let char = str.charAt(3);
// // console.log(char)
// /*________________________ Question no 47 __________________________
// string[index]
// _________________________ Answer ____________________________*/
// // let str = 'hello';
// // let ans = str[1];
// // console.log(ans);
// // let ac = str.charAt(str.length-2);
// // console.log(ac)
// /*________________________ Question no 48 __________________________
// .toUpperCase()
// _________________________ Answer ____________________________*/
// // let str = 'hello';
// // console.log(str);
...
// // str = str.toLowerCase();
// // console.log(str)
// /*________________________ Question no 49 __________________________
// Math.round();
// _________________________ Answer ____________________________*/
// // let num = 32.67;
// // console.log(num);
// // num = Math.round(num);
// // console.log(num)
// /*________________________ Question no 50 __________________________
// math.sqrt()
// _________________________ Answer ____________________________*/
// // let num = 9;
